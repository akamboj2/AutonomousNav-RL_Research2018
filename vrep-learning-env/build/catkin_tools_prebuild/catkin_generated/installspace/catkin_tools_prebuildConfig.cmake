...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/isler/Abhi/catkin_ws/src/vrep-learning-env/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/isler/Abhi/catkin_ws/src/vrep-learning-env/install/lib;/home/isler/minghan/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
